...
const EditBlog = () => {
    ...
    const {categories, blogs} = useContext(AppContext)
    ...
    const handleEdit = (e) => {
        ...
        fetch('http://localhost:5000/updateblog', requestOptions)
    ...
    return (
        <form>
            ...
            <div className="pt-2 space-y-2">
                ...
                <button onClick={handleEdit} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Update</button>
            </div>
